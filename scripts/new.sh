...
# Create test project
dotnet new xunit -n "$APP_NAME.BusinessLogic.UnitTests" -o "$APP_NAME.BusinessLogic.UnitTests" --framework net8.0
...
echo "" >> "../README.md"
echo "[![.NET](https://github.com/${GITHUB_NAME}/${REPO_NAME}/actions/workflows/dotnet.yml/badge.svg?branch=xunit)](https://github.com/${GITHUB_NAME}/${REPO_NAME}/actions/workflows/dotnet.yml)" >> "../README.md"

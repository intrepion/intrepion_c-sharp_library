...
# Create test project
dotnet new classlib -n "$APP_NAME.BusinessLogic.UnitTests" -o "$APP_NAME.BusinessLogic.UnitTests" --framework net8.0
cd $APP_NAME.BusinessLogic.UnitTests && dotnet add package TUnit --prerelease && cd ..
